...
const COMPONENTS = {
  spreadsheet: {
    ...
    subdirs: {
      'components/cells': ['ActiveCell.tsx', 'Cell.tsx', 'DataEditor.tsx', 'DataViewer.tsx'],
      'components/layout': ['HeaderRow.tsx', 'Row.tsx', 'Table.tsx'],
      'components/overlays': ['Copied.tsx', 'FloatingRect.tsx', 'Selected.tsx'],
      'components/indicators': ['ColumnIndicator.tsx', 'RowIndicator.tsx', 'CornerIndicator.tsx'],
      'core': ['actions.ts', 'areModelsEqual.ts', 'context.ts', 'reducer.ts', 'util.ts'],
      'data-structures': ['matrix.ts', 'point.ts', 'point-range.ts', 'selection.ts'],
      'engine': ['engine.ts', 'formula.ts', 'point-graph.ts', 'point-hash.ts', 'point-set.ts', 'index.ts'],
      'hooks': ['use-dispatch.ts', 'use-selector.ts'],
    },
    dependencies: [
      'classnames',
      'fast-formula-parser',
